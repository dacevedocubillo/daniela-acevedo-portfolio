...
function HomePage() { return <><About/><Suspense fallback={<SectionLoader height="h-screen"/>}><Projects/></Suspense><Suspense fallback={<SectionLoader height="h-screen"/>}><Skills/></Suspense><Services/><Suspense fallback={<SectionLoader height="h-screen"/>}><Experience/></Suspense><Suspense fallback={<SectionLoader height="h-64"/>}><Certifications/></Suspense><Suspense fallback={<SectionLoader height="h-64"/>}><Contact/></Suspense></>; }
